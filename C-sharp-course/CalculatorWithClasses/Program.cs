...
namespace CalculatorWithClasses
{
    class Program
    {
        ...
        {
            List<string> Expressions1 = new List<string> { "70+50", "5 *((70+50)/10 - 20)", "7*((1+3)/1 - 9", "6 + 2.5*2",
                "9 + 7/2" };
            ...
            List<string> Expressions2 = new List<string> { "5+7*9 -  8", "8 + 2.3. - 9", "5 + -7", " 5 7*3", "10*5:8", "7 + 5/(10 - 20*0.5)" };
